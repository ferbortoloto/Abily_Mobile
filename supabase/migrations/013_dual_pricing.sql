-- ============================================================
-- Adiciona preço separado para moto (categoria A).
--
-- Lógica:
--   • price_per_hour      → aulas de carro (cat. B)
--   • price_per_hour_moto → aulas de moto  (cat. A)
--   • Cat. A+B pode ter os dois preços preenchidos.
-- ============================================================

-- 1. Nova coluna
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS price_per_hour_moto numeric DEFAULT NULL;

-- 2. Atualiza a RPC de cadastro para aceitar o novo parâmetro
