-- ============================================================
-- Adiciona campo RENACH (Registro Nacional de Carteira de
-- Habilitação) ao perfil de alunos.
--
-- Formato: 2 letras (UF) + 9 dígitos — ex: SP123456789
-- Campo opcional no cadastro; obrigatório antes de marcar aula.
-- ============================================================

ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS renach text DEFAULT NULL;

-- Remove versão anterior da RPC para substituir com novo parâmetro
DROP FUNCTION IF EXISTS public.complete_profile_after_signup(uuid,text,text,text,text,date,text,text,text,text,text,integer,text,numeric,numeric,text,text,boolean,boolean,text,integer,text,text);
